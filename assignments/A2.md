...
- 3 points if the test accuracy from the last screenshot is higher than that of A1.
- 3 points if the implementation of uncertainty sampling is correct (all unit tests pass).
