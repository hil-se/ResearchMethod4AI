...
- Install miniconda first. These four commands download the latest 64-bit version of the Linux installer, rename it to a shorter file name, silently install, and then delete the installer (more [documentation](https://docs.anaconda.com/miniconda/install/)):
```
mkdir -p ~/miniconda3
...
```
conda create -n tf2_gpu_env python==3.11.10
...
- Install [pandas](https://pandas.pydata.org/) and [pillow](https://pypi.org/project/Pillow/)
```
